...
install :; forge install foundry-rs/forge-std --no-commit && forge install openzeppelin/openzeppelin-contracts-upgradeable@v5.0.0 --no-commit && forge install cyfrin/foundry-devops@0.0.11 --no-commit 
